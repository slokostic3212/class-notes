...
/*
create a map that contains name and salary
	find max salary it contains

	create a map that contains student name and score
	use 5 student names
	print out highest score you have
